 ...
 */
package br.com.vivo.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Vivob2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Vivob2bFulfilmentProcessConstants.PARENT_PROCESS);
