 ...
 */
package br.com.vivo.b2b.test.setup;
...
import br.com.vivo.b2b.test.constants.Vivob2bTestConstants;
import br.com.vivo.b2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Vivob2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/vivob2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/vivob2btest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/vivob2btest/import/cstickets.impex");
			...
			importImpexFile(context, "/vivob2btest/import/csquotes.impex");
		}
	}
}
